...
const References = () => {
    return (
        ...
        >
            <p className="text-4xl font-medium">- Referanslarımız -</p>
            <div className="relative aspect-[1.75] w-[60%] rounded-3xl overflow-hidden bg-secondary shadow-[0_8px_22px_-12px] shadow-black max-md:w-[94%]">
                <Image
